...
test('the jira sync runs outside work hours', function () {
    expect(scheduledEventAt('jira:sync', '2026-01-01 07:55:00')->filtersPass(app()))->toBeTrue();
    expect(scheduledEventAt('jira:sync', '2026-01-01 12:00:00')->filtersPass(app()))->toBeTrue();
    expect(scheduledEventAt('jira:sync', '2026-01-01 16:05:00')->filtersPass(app()))->toBeTrue();
});

test('the jira sync runs every day of the week', function () {
    expect(scheduledEventAt('jira:sync', '2026-01-05 12:00:00')->isDue(app()))->toBeTrue() // Monday
        ...
        ->and(scheduledEventAt('jira:sync', '2026-01-02 12:00:00')->isDue(app()))->toBeTrue() // Friday
        ->and(scheduledEventAt('jira:sync', '2026-01-03 12:00:00')->isDue(app()))->toBeTrue() // Saturday
        ->and(scheduledEventAt('jira:sync', '2026-01-04 12:00:00')->isDue(app()))->toBeTrue(); // Sunday
});
